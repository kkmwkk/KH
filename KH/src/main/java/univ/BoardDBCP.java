...
public class BoardDBCP {
	...
	public ArrayList<BoardEntity> getBoardList() {
		...
		String SQL = "select * from board_3 ORDER BY id DESC";
	...
	public BoardEntity getBoard(int id) {
		...
		String SQL = "select * from board_3 where id = ?";
	...
	public boolean insertDB(BoardEntity board) {
		...
		String sql = "insert into board_3 values(board_5_seq.nextval, ?, ?, ?, ?, ?, sysdate, ?)";
	...
	public boolean deleteDB(int id) {
		...
		String sql = "delete from board_3 where id=?";
	...
	public boolean isPasswd(int id, String passwd) {
		...
		String sql = "select passwd from board_3 where id=?";
